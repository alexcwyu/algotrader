package com.unisoft.algotrader.utils.serialization.sbe;
...
public class SBESerializationTest {
    ...
    private void encodeDecode(MessageHeader MESSAGE_HEADER, UnsafeBuffer directBuffer, short messageTemplateVersion) throws Exception {
        ...
        Assert.assertEquals(quote.symbolId(), quote2.symbolId());
        Assert.assertEquals(quote.bid(), quote2.bid(), 0.0001);
        Assert.assertEquals(quote.ask(), quote2.ask(), 0.0001);
        Assert.assertEquals(quote.bidVol(), quote2.bidVol());
        Assert.assertEquals(quote.askVol(), quote2.askVol());
    }
    ...
    public static void assertQuote(Quote quote, long id){
        Assert.assertEquals(id, quote.symbolId());
        Assert.assertEquals(98, quote.bid(), 0.0001);
        Assert.assertEquals(99, quote.ask(), 0.0001);
        Assert.assertEquals(500, quote.bidVol());
        Assert.assertEquals(329, quote.askVol());
