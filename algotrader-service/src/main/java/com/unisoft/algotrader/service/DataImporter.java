...
public class DataImporter implements MarketDataHandler {
    ...
    public DataImporter(ProviderManager providerManager, DataService dataService){
    ...
    public static void main(String [] args){
        ...
        DataImporter importer = new DataImporter(providerManager, dataService);

        MultiEventProcessor processor = new MultiEventProcessor();
        processor.add(eventBusManager.getMarketDataRB(), importer);
