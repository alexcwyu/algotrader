...
public class EventBusManager {
    ...
    //public final RingBuffer<Bar> barRB = RingBuffer.createSingleProducer(Bar.FACTORY, DEFAULT_BUFFER_SIZE, new NoWaitStrategy());
//    public final RingBuffer<Quote> quoteRB = RingBuffer.createSingleProducer(Quote.FACTORY, DEFAULT_BUFFER_SIZE, new NoWaitStrategy());
//    public final RingBuffer<Trade> tradeRB = RingBuffer.createSingleProducer(Trade.FACTORY, DEFAULT_BUFFER_SIZE, new NoWaitStrategy());
