...
public class PortfolioTest {
    ...
    private static Instrument instrument1 = new Instrument("HSI","HKEX","HKD");
    private static Instrument instrument2 = new Instrument("0005.HK","HKEX","HKD");
    private static Instrument instrument3= new Instrument("0959.HK","HKEX","HKD");
    ...
    public void test_position_value(){
        ...
        Order order = limitOrder("HSI", 10000, 2, Side.Buy);
        ...
        order = limitOrder("HSI", 10000, 1, Side.Buy);
        ...
        order = limitOrder("HSI", 18000, 1, Side.Buy);
        er = executionReport(order);
        order.add(er);
        portfolio.add(order);
        ...
        order = limitOrder("HSI", 20000, 6, Side.Sell);
        er = executionReport(order);
        order.add(er);
        portfolio.add(order);
        ...
        order = limitOrder("0005.HK", 2000, 50, Side.Buy);
        er = executionReport(order);
        order.add(er);
        portfolio.add(order);
        //(-20000 * 2) + 2000 * 50
        ...
        order = limitOrder("0959.HK", 85, 10, Side.Buy);
        er = executionReport(order);
        order.add(er);
        portfolio.add(order);
        ...
        portfolio.onTrade(new Trade("0959.HK", System.currentTimeMillis(), 88, 1));
        assertEquals(60880, portfolio.positionValue(), 0.0);

        //(-21000 * 2) + 2000 * 50 + 88 * 10
        portfolio.onQuote(new Quote("HSI", System.currentTimeMillis(), 19000, 21000, 1, 1));
        assertEquals(58880, portfolio.positionValue(), 0.0);

        //(-21000 * 2) + 2000 * 50 + 87 * 10
        portfolio.onQuote(new Quote("0959.HK", System.currentTimeMillis(), 87, 89, 1, 1));
        assertEquals(58870, portfolio.positionValue(), 0.0);

        portfolio.onBar(new Bar("0005.HK", System.currentTimeMillis(), 60, 2100, 1900, 2000, 2050, 1, 1));
    ...
    public void test_position_value_with_marketdate_update() {
        ...
        Order order = limitOrder("HSI", 20000, 2, Side.Sell);
        ExecutionReport er = executionReport(order);
        order.add(er);
        portfolio.add(order);
    ...
    public void test_cash_flow(){
        Order order = limitOrder("0005.HK", 2000, 50, Side.Buy);
        ExecutionReport er = executionReport(order);
        order.add(er);
        portfolio.add(order);
        assertEquals(-100000, portfolio.cashFlow(), 0.0);

        order = limitOrder("HSI", 20000, 2, Side.Sell);
        er = executionReport(order);
        order.add(er);
        portfolio.add(order);
    ...
    public void test_partial_close_and_fully_close(){
        ...
        Order buyOrder = limitOrder("HSI", 10000, 2, Side.Buy);
        ...
        Order sellOrder1 = limitOrder("HSI", 15000, 1, Side.Sell);
        ...
        Order sellOrder2 = limitOrder("HSI", 20000, 1, Side.Sell);
    ...
    private Order limitOrder(String instId, double limitPx, double qty, Side side){
