...
import com.unisoft.algotrader.provider.ib.api.event.VerifyCompletedEvent;
 ...
 */
public class VerifyCompletedEventDeserializer extends Deserializer<VerifyCompletedEvent> {
