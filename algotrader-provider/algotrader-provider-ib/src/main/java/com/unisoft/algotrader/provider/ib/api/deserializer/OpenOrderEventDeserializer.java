...
public class OpenOrderEventDeserializer extends Deserializer {
    ...
    public void consumeVersionLess(InputStream inputStream, IBSession ibSession) {
        ...
        Order order = parseOrder(inputStream, orderId);
    ...
    protected Instrument parseInstrument(final InputStream inputStream, final RefDataStore refDataStore) {
        final int instId = (getVersion() >= 17)? readInt(inputStream) : 0;
        ...
        final String multiplier = (getVersion() >= 17)? readString(inputStream) : null;
        ...
        final String tradingClass = (getVersion() >= 32)? readString(inputStream): null;
    ...
    protected Order parseOrder(final InputStream inputStream, final int orderId){
        ...
        final String goodAfterDateTime = (getVersion() >= 5) ? readString(inputStream) : null;
        ...
        final String goodTillDateTime = (getVersion() >= 8) ? readString(inputStream) : null;
